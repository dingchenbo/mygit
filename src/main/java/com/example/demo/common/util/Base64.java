...
{
    /**
     * Chunk size per RFC 2045 section 6.8. <p>The {@value} character limit does not count the
     * trailing CRLF, but counts all other characters, including any equal signs.</p>
     * 
     ...
     * @param arrayOctect
     *            byte array to test
     * @return true if all bytes are valid characters in the Base64 alphabet or if the byte array
     ...
     * RFC 2045 - "Any characters outside of the base64 alphabet are to be ignored in base64
     * encoded data."
     * 
     * @param data
