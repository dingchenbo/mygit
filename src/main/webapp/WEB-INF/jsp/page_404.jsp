...
<style>
.tipBox{padding-bottom:50px;border:#ddd 1px solid;background-color:#f5f5f5; background-image:url("${basePath}images/seller/404.png");background-position:900px center;background-repeat:no-repeat;}
  			...
  			<div class="e_main tipBox ">
				...
				<div class="row nobg mt_25">
					...
					<div class="col-x-4">
						...
						<a href="${basePath}index.jsp" class="frm_btn btn_def">返回首页</a>
					</div>
				</div>
			</div>		
