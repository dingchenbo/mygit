...
<style>
.tipBox{padding-bottom:50px;border:#ddd 1px solid;background-color:#f5f5f5; background-image:url("${basePath}images/seller/500.png");background-position:900px center;background-repeat:no-repeat;}
  		...
  		<!-- ------------------------------------ 正文代码开始 start ------------------------------------ -->
  			...
  			<div class="e_main tipBox">
				<div class="row nobg mt_15">
					...
					<div class="col-x-4">
						<div class="tipTle mt_15"><span>500</span>系统开小差了</div>
					</div>
				</div>
				<div class="row nobg">
					<div class="col-x-1"></div>
					<div class="col-x-4">
						<span class="tipTle mt_15">服务器可能比较忙或者开小差了，请稍后重新再试一次!</span>
					</div>
				</div>
				<div class="row nobg">
					<div class="col-x-1"></div>
				...
				<div class="row nobg mt_25">
					...
					<div class="col-x-4">
						...
						<a href="${basePath}" class="frm_btn btn_def">返回首页</a>
					</div>
				</div>
			</div>		
